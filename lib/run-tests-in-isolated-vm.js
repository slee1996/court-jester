...
async function runTestsInIsolatedVm(testFilePath) {
  ...
  //   const createEnvironment = require('@jest/environment').default;
  //   const config = require('@jest/types').Config;
  //   const testEnvironment = new createEnvironment(new config.ProjectConfig({ testEnvironment: "node" }));
  //   testEnvironment.setup();

  //   Object.assign(globalThis, testEnvironment.global);
  // `,
  //   { timeout: 10000 }
  // );
